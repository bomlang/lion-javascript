...
// 배열 요소 추가
let unshift = friend.unshift('q'); //얖 요소 추가
console.log(friend);

let push = friend.push('m'); //뒤 요소 추가
console.log(friend);

// 배열 요소 제거
let shift = friend.shift('m'); //앞 요소 제거
console.log(friend);

let pop = friend.pop('e'); //뒤 요소 제거
console.log(friend);
